...
```json
{"level":"ERROR","category":"sync","message":"sync_fail","meta":{"schemaVersion":2,"syncRunId":"…","stage":"sync_fail","errorKind":"ui_selector_timeout","errorStage":"fetch_transactions","runtime":{"appVersion":"2.0.33","scraperPackageVersion":"github:HirezRa/israeli-bank-scrapers#hirez-v1.0.12"}}}
```
