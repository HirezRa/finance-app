  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'fixed left-1/2 top-1/2 z-50 grid -translate-x-1/2 -translate-y-1/2 gap-4 border border-white/20 bg-white/90 p-6 shadow-2xl backdrop-blur-2xl duration-200 dark:border-white/10 dark:bg-[#1e293b]/95 sm:rounded-2xl',
