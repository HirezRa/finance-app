...
- israeli-bank-scrapers → hirez-v1.0.20 (`1c9b998c230d7936c2a232aa7f2b8729a007fada`).

## [2.0.56] - 2026-05-14

- תיקון healthcheck פרונטאנד (wget ללא `--spider`) + התקנת `wget` באימג׳.
...
- ריפוי יומי ב־DB: איפוס `effectiveDate` להכנסות עם יום בנק ישראלי 1–14 (שירות cron + משתני סביבה לכיבוי/גבול סריקה).
